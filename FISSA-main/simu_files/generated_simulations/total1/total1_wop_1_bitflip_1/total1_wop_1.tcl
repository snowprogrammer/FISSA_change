#############  INIT SIMULATIONS #############
set regs_file /home/zhao/mo_project/total1/total1_wop_1_bitflip_1/faulted_regs.yaml
set state_file /home/zhao/mo_project/total1/total1_wop_1_bitflip_1/results/total1_wop_1.json
...
###### JUMP TO ATTACK START ######
set start_sim "9958 ns"
run "9958 ns" ;# Saut vers la fenêtre d'attaque

set nb_cycle [expr [expr 9958 - $start] / $periode]
set sim_active 1
##---------------------
...
puts "Simulation number : $nb_sim"
###### JUMP TO ATTACK START ######
set start_sim "9966 ns"
run "9966 ns" ;# Saut vers la fenêtre d'attaque

set nb_cycle [expr [expr 9966 - $start] / $periode]
set sim_active 1
##---------------------
###### FORCE VALUE ON FAULTED REGISTER ######
set threat "bitflip"
...
puts "Simulation number : $nb_sim"
###### JUMP TO ATTACK START ######
set start_sim "9974 ns"
run "9974 ns" ;# Saut vers la fenêtre d'attaque

set nb_cycle [expr [expr 9974 - $start] / $periode]
set sim_active 1
##---------------------
###### FORCE VALUE ON FAULTED REGISTER ######
set threat "bitflip"
...
puts "Simulation number : $nb_sim"
###### JUMP TO ATTACK START ######
set start_sim "9982 ns"
run "9982 ns" ;# Saut vers la fenêtre d'attaque

set nb_cycle [expr [expr 9982 - $start] / $periode]
set sim_active 1
##---------------------
###### FORCE VALUE ON FAULTED REGISTER ######
set threat "bitflip"
