#############  INIT SIMULATIONS #############
set regs_file /home/zhao/mo_project/total5/total5_wop_1_bitflip_1/faulted_regs.yaml
set state_file /home/zhao/mo_project/total5/total5_wop_1_bitflip_1/results/total5_wop_1.json
...
###### JUMP TO ATTACK START ######
set start_sim "10742 ns"
run "10742 ns" ;# Saut vers la fenêtre d'attaque

set nb_cycle [expr [expr 10742 - $start] / $periode]
set sim_active 1
##---------------------
...
puts "Simulation number : $nb_sim"
###### JUMP TO ATTACK START ######
set start_sim "10750 ns"
run "10750 ns" ;# Saut vers la fenêtre d'attaque

set nb_cycle [expr [expr 10750 - $start] / $periode]
set sim_active 1
##---------------------
###### FORCE VALUE ON FAULTED REGISTER ######
set threat "bitflip"
...
puts "Simulation number : $nb_sim"
###### JUMP TO ATTACK START ######
set start_sim "10758 ns"
run "10758 ns" ;# Saut vers la fenêtre d'attaque

set nb_cycle [expr [expr 10758 - $start] / $periode]
set sim_active 1
##---------------------
###### FORCE VALUE ON FAULTED REGISTER ######
set threat "bitflip"
...
puts "Simulation number : $nb_sim"
###### JUMP TO ATTACK START ######
set start_sim "10766 ns"
run "10766 ns" ;# Saut vers la fenêtre d'attaque

set nb_cycle [expr [expr 10766 - $start] / $periode]
set sim_active 1
##---------------------
###### FORCE VALUE ON FAULTED REGISTER ######
set threat "bitflip"
...
puts "Simulation number : $nb_sim"
###### JUMP TO ATTACK START ######
set start_sim "10774 ns"
run "10774 ns" ;# Saut vers la fenêtre d'attaque

set nb_cycle [expr [expr 10774 - $start] / $periode]
set sim_active 1
##---------------------
###### FORCE VALUE ON FAULTED REGISTER ######
set threat "bitflip"
...
puts "Simulation number : $nb_sim"
###### JUMP TO ATTACK START ######
set start_sim "10782 ns"
run "10782 ns" ;# Saut vers la fenêtre d'attaque

set nb_cycle [expr [expr 10782 - $start] / $periode]
set sim_active 1
##---------------------
###### FORCE VALUE ON FAULTED REGISTER ######
set threat "bitflip"
...
puts "Simulation number : $nb_sim"
###### JUMP TO ATTACK START ######
set start_sim "10790 ns"
run "10790 ns" ;# Saut vers la fenêtre d'attaque

set nb_cycle [expr [expr 10790 - $start] / $periode]
set sim_active 1
##---------------------
###### FORCE VALUE ON FAULTED REGISTER ######
set threat "bitflip"
...
puts "Simulation number : $nb_sim"
###### JUMP TO ATTACK START ######
set start_sim "10798 ns"
run "10798 ns" ;# Saut vers la fenêtre d'attaque

set nb_cycle [expr [expr 10798 - $start] / $periode]
set sim_active 1
##---------------------
###### FORCE VALUE ON FAULTED REGISTER ######
set threat "bitflip"
