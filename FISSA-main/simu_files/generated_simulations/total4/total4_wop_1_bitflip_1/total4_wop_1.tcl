#############  INIT SIMULATIONS #############
set regs_file /home/zhao/mo_project/total4/total4_wop_1_bitflip_1/faulted_regs.yaml
set state_file /home/zhao/mo_project/total4/total4_wop_1_bitflip_1/results/total4_wop_1.json
...
###### JUMP TO ATTACK START ######
set start_sim "10654 ns"
run "10654 ns" ;# Saut vers la fenêtre d'attaque

set nb_cycle [expr [expr 10654 - $start] / $periode]
set sim_active 1
##---------------------
...
puts "Simulation number : $nb_sim"
###### JUMP TO ATTACK START ######
set start_sim "10662 ns"
run "10662 ns" ;# Saut vers la fenêtre d'attaque

set nb_cycle [expr [expr 10662 - $start] / $periode]
set sim_active 1
##---------------------
###### FORCE VALUE ON FAULTED REGISTER ######
set threat "bitflip"
...
puts "Simulation number : $nb_sim"
###### JUMP TO ATTACK START ######
set start_sim "10670 ns"
run "10670 ns" ;# Saut vers la fenêtre d'attaque

set nb_cycle [expr [expr 10670 - $start] / $periode]
set sim_active 1
##---------------------
###### FORCE VALUE ON FAULTED REGISTER ######
set threat "bitflip"
