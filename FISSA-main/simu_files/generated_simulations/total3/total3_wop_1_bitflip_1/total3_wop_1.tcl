#############  INIT SIMULATIONS #############
set regs_file /home/zhao/mo_project/total3/total3_wop_1_bitflip_1/faulted_regs.yaml
set state_file /home/zhao/mo_project/total3/total3_wop_1_bitflip_1/results/total3_wop_1.json
...
###### JUMP TO ATTACK START ######
set start_sim "10582 ns"
run "10582 ns" ;# Saut vers la fenêtre d'attaque

set nb_cycle [expr [expr 10582 - $start] / $periode]
set sim_active 1
##---------------------
...
puts "Simulation number : $nb_sim"
###### JUMP TO ATTACK START ######
set start_sim "10590 ns"
run "10590 ns" ;# Saut vers la fenêtre d'attaque

set nb_cycle [expr [expr 10590 - $start] / $periode]
set sim_active 1
##---------------------
###### FORCE VALUE ON FAULTED REGISTER ######
set threat "bitflip"
...
puts "Simulation number : $nb_sim"
###### JUMP TO ATTACK START ######
set start_sim "10598 ns"
run "10598 ns" ;# Saut vers la fenêtre d'attaque

set nb_cycle [expr [expr 10598 - $start] / $periode]
set sim_active 1
##---------------------
###### FORCE VALUE ON FAULTED REGISTER ######
set threat "bitflip"
...
puts "Simulation number : $nb_sim"
###### JUMP TO ATTACK START ######
set start_sim "10606 ns"
run "10606 ns" ;# Saut vers la fenêtre d'attaque

set nb_cycle [expr [expr 10606 - $start] / $periode]
set sim_active 1
##---------------------
###### FORCE VALUE ON FAULTED REGISTER ######
set threat "bitflip"
